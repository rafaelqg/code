...
*/
/*
let publicKeyLiteral = `-----BEGIN PUBLIC KEY-----
MFwwDQYJKoZIhvcNAQEBBQADSwAwSAJBAIb1ywaju2rYK/WluFijEPvKb5MIUlxz
9W8ng2YI5VscBYBZAXGYkB7HJ1qdKU7uEXF9JocJ3JMj5pAPOh93bxMCAwEAAQ==
-----END PUBLIC KEY-----`
rsaKey = new NodeRSA(publicKeyLiteral);
*/
...
const signedContentBase64 = encrypted.toString('base64');
console.log('signed: ', signedContentBase64);
let signatureValid = rsaKey.verify(text, signedContent);
